...
def faq_instructions(
    ...
    return (
        ...
        "2. Search your knowledge base for a relevant answer.\n"
        "3. If found: reply to the customer first, then transfer to Triage Agent. NEVER transfer before sending your reply.\n"
        "4. If not found: follow the handoff skill below.\n"
