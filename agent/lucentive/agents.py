...
PLAIN_TEXT_RULE = (
    ...
    "NATURAL CONVERSATION: When a customer asks a side or clarifying question mid-conversation, answer that question and stop. "
    "Do not append or restate the current stage question in the same message. "
    "Resume the flow only on a later turn when the timing is natural, and never copy-paste your previous question.\n"
