...
- `reason_20_min_unavailable`: "We open in 25 minutes; we can't offer a 10-minute callback yet."

**Decision:** Offer 2–4 hours callback (we'll be open soon; I can call within that window).

**Example user response:** "We're not quite open yet — we open in about 25 minutes. I can call you within the next 2–4 hours. Does that work?"
...
**Example user response:** "We're not quite open yet — we open in about 1 hour 45 minutes. I can call you within the next 2–4 hours. Does that work?"
...
### Open but user declined 10-min (stepping down to 2–4 hours)

**Tool response (example):**
- `status`: "open"
- `available_offers`: ["2_4_hours", "calendly"] (after excluding `20_min`)

**Decision:** Offer 2–4 hours. We're open so do NOT say "we're not quite open yet" — just offer the next option.

**Example user response:** "No problem — I can call you within the next 2–4 hours instead. Does that work?"
